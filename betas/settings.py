"""
Django settings for betas project.
...
SECURE_CHECKS = [
    ...
    "betas.checks.check_session_csrf_enabled",
    "betas.checks.check_csp_is_not_report_only"
]
...
ROOT_URLCONF = 'betas.urls'

WSGI_APPLICATION = 'betas.wsgi.application'
